import { assertIsNumber } from '~/workers/physics/utils/assertions'
import { raiseError } from '~/workers/physics/utils/error-handling'
import { isNumber } from '~/workers/physics/utils/is'
...
export class Vector2D {
  ...
  constructor(
    ...
    assertIsNumber('Component x must be a number')
    assertIsNumber('Component y must be a number')
